...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark
        @if( !in_array(Request::route()->getName(), ['website','website.rooms','website.about','website.contact'])  )
        ftco-navbar-dark
        @else ftco-navbar-light @endif"
     id="ftco-navbar">
	<div class="container">
		<a class="navbar-brand" href="{{ route('website') }}">{{ config('app.name') }}</a>
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				...
				@else
					<li class="nav-item">
						<a href='#' class="nav-link" data-toggle="modal" data-target="#registration">Signup</a>
					</li>
					<li class="nav-item">
						<a href='#' class="nav-link" class="btn btn-primary" data-toggle="modal" data-target="#login">Login</a></li>
				@endauth
